...
wss.on('connection', (ws) => {
  ...
  ws.on('message', (raw) => {
    try {
      ...
      const allowedControlTypes = new Set(['mouse-move', 'mouse-down', 'mouse-up', 'mouse-click', 'mouse-scroll', 'key-down', 'key-up', 'text', 'release-input', 'host-alt-tab', 'set-stream-quality', 'set-osk-mode', 'gamepad-state']);
